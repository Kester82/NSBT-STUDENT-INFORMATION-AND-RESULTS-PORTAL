        ...
        <div class="row g-4">
            ...
            <div class="col-lg-9">
                <div class="mb-4">
                    ...
                    <h1 class="h2 fw-bold mb-1">Manage Results</h1>
                    <p class="text-muted mb-0">
                        Enter or correct academic results for enrolled students.
                    </p>
                </div>
                ...
                <div class="card dashboard-card mb-4">
                    <div class="card-body p-4">
                        <form method="GET" action="<?= APP_URL ?>/public/admin/results.php">
                    ...
                    <div class="card dashboard-card">
                        <div class="card-body p-0">
                            <div class="p-4 border-bottom">
                                ...
                                <p class="text-muted mb-0">
                                    Enter scores from 0 to 100. Grades are calculated automatically.
                                </p>
                            </div>
                            ...
                            <?php else: ?>
                                <form method="POST" action="<?= APP_URL ?>/public/admin/results.php">
                                    <input
                                        type="hidden"
                                        name="csrf_token"
